...
const translations = {
  en: {
    ...
    aboutText: "I've gone from academic drawing and marketing to product design and AI. That journey helps me understand users, business goals and technology equally well. I work across the full product lifecycle: research, UX, interfaces, design systems, product launches, hypothesis validation and continuous improvement. For the past three years I've led design across 20+ products at MiraiTech. By integrating AI workflows into the team's daily process, I improved the efficiency of two major SaaS products. I also built an MVP delivery process that reduced Time-to-Market from one week to five hours.",
    ...
    services: [
      ...
      { name: 'Mentorship', desc: 'Since 2020 I\'ve been mentoring product designers through CONTENTED and Skillbox. More than 1000 students have completed my programs. I help designers build structured thinking, stronger product skills and confidence through real-world projects.' },
    ],
  ...
  ru: {
    ...
    aboutText: 'Прошел путь от академического рисунка и маркетинга до продуктового дизайна и AI. Это помогает одинаково хорошо понимать пользователя, бизнес и технологии. Работаю с полным циклом. Исследование, UX, интерфейсы, дизайн-системы, запуск, проверка гипотез и развитие продукта. Последние 3 года отвечал за дизайн 20+ продуктов в MiraiTech. Интегрируя AI-пайплайны в рабочие процессы команды, повысил эффективность двух крупных SaaS-продуктов. Настроил процесс запуска MVP, который сократил Time-to-Market с недели до 5 часов.',
    ...
    services: [
      ...
      { name: 'Менторство', desc: 'С 2020 года преподаю продуктовый дизайн в CONTENTED и Skillbox. Более 1000 студентов прошли мои программы. Помогаю дизайнерам расти быстрее через системный подход, продуктовое мышление и работу с реальными кейсами.' },
    ],
