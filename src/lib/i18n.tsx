...
const translations = {
  en: {
    ...
    aboutText: "I went from academic drawing and marketing to product design and AI. That path helps me understand users, business, and technology equally well. I work across the full product lifecycle: research, UX, interfaces, design systems, launches, hypothesis validation, and continuous improvement. From 2023 to 2026 I led design across 20+ products at MiraiTech, managing small cross-platform teams. I built an MVP delivery process that cut Time-to-Market from one week to five hours. In 2024 I launched an educational platform for FlipperZero and led a Skillbox bootcamp as product lead, building the full funnel from ad to purchase.",
    ...
    projects: [
      ...
      {
        num: '08', category: '2024 — Product Lead', name: 'Skillbox Bootcamp', tag: 'EdTech · Product Launch',
        metrics: ['full funnel ad → purchase', 'audience research + benchmarking', 'Telegram mini app launch'],
        task: 'Skillbox needed a bootcamp for junior designers that converts. If we research the audience, map their barriers, and build a funnel from ad to Telegram mini app to course purchase, conversion improves because content addresses real fears, not abstract topics.',
        whatWasDone: 'Researched junior designer audience and benchmarked competitors. Designed the full funnel: ad → landing → Telegram mini app → course → purchase. Built content covering two halves: practice (design basics, layout, Figma, AI tools) and barriers (fear to start, imposter syndrome, career path). Metrics at every step. Not a design case, a product and marketing one.',
        result: 'Full funnel launched and running. Product approach to education: audience researched, barriers mapped, content designed to convert. Proof of cross-functional product thinking beyond pixels.',
        role: 'Product Lead / Mentor', duration: '1 year', team: '',
        images: { col1Top: 'images/Miraitech-Top.png', col1Bottom: 'images/Miraitech-col1-Botton.png', col2: 'images/Miraitech-col2.png' },
        notionUrl: 'https://bootcamp.skillbox.ru/design_miniapp',
      },
    ],
  ...
  ru: {
    ...
    projects: [
      ...
      {
        num: '08', category: '2024 — Продакт-лид', name: 'Skillbox Bootcamp', tag: 'EdTech · Запуск продукта',
        metrics: ['полная воронка реклама → покупка', 'исследование ЦА + бенчмаркинг', 'запуск Telegram mini app'],
        task: 'Skillbox нужен был буткэмп для начинающих дизайнеров, который конвертирует. Если исследовать аудиторию, замапить барьеры и построить воронку от рекламы через мини-апп в Telegram до покупки курса, конверсия вырастет, потому что контент закрывает реальные страхи, а не абстрактные темы.',
        whatWasDone: 'Исследовал аудиторию junior-дизайнеров, провел бенчмаркинг конкурентов. Спроектировал полную воронку: реклама → лендинг → Telegram mini app → курс → покупка. Построил контент: половина практика (основы дизайна, вёрстка, Figma, AI-тулзы), половина барьеры (страх начать, синдром самозванца, путь в профессию). Метрики на каждом шаге. Не кейс про дизайн, а про продукт и маркетинг.',
        result: 'Полная воронка запущена и работает. Продуктовый подход к образованию: аудитория исследована, барьеры замаплены, контент построен на конверсию. Доказательство продуктового мышления за пределами пикселей.',
        role: 'Продакт-лид / Ментор', duration: '1 год', team: '',
        images: { col1Top: 'images/Miraitech-Top.png', col1Bottom: 'images/Miraitech-col1-Botton.png', col2: 'images/Miraitech-col2.png' },
        notionUrl: 'https://bootcamp.skillbox.ru/design_miniapp',
      },
    ],
